...
hook.Add("HUDPaint", "Prison02Obj", function(ply)
...
// Check the map + convars n shit
	if game.GetMap() == "d2_prison_02" and GetConVar("ObjSysEnabled"):GetInt() == 1 then
...
if CurObjMarker == 14 then
	...
	SubObjTriggerSpot = ( XPos == math.Clamp(XPos, -2376, -2256) and YPos == math.Clamp(YPos, 1472, 1728) )
end
